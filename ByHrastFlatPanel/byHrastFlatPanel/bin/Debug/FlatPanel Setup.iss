...
; Generated by matija on 22.11.2024. (UTC)
;
[Setup]
AppID={{b38a4c33-d5d9-4d10-8978-2ffd2f49bfa7}
AppName=ASCOM FlatPanel CoverCalibrator Driver
AppVerName=ASCOM FlatPanel CoverCalibrator Driver
AppVersion=1
...
OutputDir="."
OutputBaseFilename="FlatPanel Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\CoverCalibrator\FlatPanel"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\FlatPanel"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\hrast\Dropbox\Projekti\ASCOM\FlatPanel\ByHrastFlatPanel\byHrastFlatPanel\bin\Debug\ASCOM.byHrastFlatPanel.exe"; DestDir: "{app}"
; TODO: Add driver assemblies into the ServedClasses folder
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\hrast\Dropbox\Projekti\ASCOM\FlatPanel\ByHrastFlatPanel\byHrastFlatPanel\bin\Debug\Readme.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{app}\ASCOM.byHrastFlatPanel.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.byHrastFlatPanel.exe"; Parameters: "/unregister"
