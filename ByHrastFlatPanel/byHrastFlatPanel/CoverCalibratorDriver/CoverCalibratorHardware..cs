...
//
// ASCOM CoverCalibrator hardware class for byHrastFlatPanel
//
    ...
    internal static class CoverCalibratorHardware
    {
        ...
        static CoverCalibratorHardware()
        {
            try
            {
                ...
                tl = new TraceLogger("", "byHrastFlatPanel.Hardware");
        ...
        public static string DriverInfo
        {
            get
            {
                ...
                string driverInfo = $"byHrast driver ";
        ...
        public static string Name
        {
            ...
            get
            {
                string name = "FlatPanel/Cover byHrast";
        ...
        internal static CoverStatus CoverState
        {
            get
            {
                ...
                if (stat == 0) return CoverStatus.Unknown;
                if (stat == 1) return CoverStatus.Open;
                if (stat == 2) return CoverStatus.Closed;
                else return CoverStatus.Unknown;
            }
        }
        ...
        internal static void OpenCover()
        {
            ...
            //System.Windows.Forms.MessageBox.Show("Cover Open");

            string url = "http://" + comPort + "/COVERstatus.htm";

            try
            {
                var request = (HttpWebRequest)WebRequest.Create(url + "?cover=1");
        ...
        internal static void CloseCover()
        {
            ...
            //System.Windows.Forms.MessageBox.Show("Cover Closed");
            string url = "http://" + comPort + "/COVERstatus.htm";

            try
            {
                var request = (HttpWebRequest)WebRequest.Create(url + "?cover=0");
        ...
        internal static CalibratorStatus CalibratorState
        {
            get
            {
                ...
                return CalibratorStatus.Ready; /// ja stavio inace javlja gresku
            }
        }
        ...
        internal static void CalibratorOff()
        {
            ...
            //// tu šaljem komandu prema FlatPanelu da je off
            ///            
