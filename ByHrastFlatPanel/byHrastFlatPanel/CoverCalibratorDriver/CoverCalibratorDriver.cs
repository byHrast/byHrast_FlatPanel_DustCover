...
//
// ASCOM CoverCalibrator driver for byHrastFlatPanel
//
...
namespace ASCOM.byHrastFlatPanel.CoverCalibrator
{
    ...
    //
    // Your driver's DeviceID is ASCOM.byHrastFlatPanel.CoverCalibrator
    //
    // The COM Guid attribute sets the CLSID for ASCOM.byHrastFlatPanel.CoverCalibrator
    // The COM ClassInterface/None attribute prevents an empty interface called _byHrastFlatPanel from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("5295b431-517a-454c-a492-fedf2eb6eb14")]
    [ProgId("ASCOM.byHrastFlatPanel.CoverCalibrator")]
    [ServedClassName("ASCOM CoverCalibrator Driver for byHrastFlatPanel")] // Driver description that appears in the Chooser, customise as required
    ...
    public class CoverCalibrator : ReferenceCountedObjectBase, ICoverCalibratorV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="byHrastFlatPanel"/> class. Must be public to successfully register for COM.
        /// </summary>
        public CoverCalibrator()
        {
            try
            {
                ...
                tl = new TraceLogger("", "byHrastFlatPanel.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.byHrastFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
